...
void testAddGuassianNoise() {
  ...
  AddGaussianNoise(srcimg->image, dstimg->image, srcimg->width, srcimg->height,
                   mean, stddev);
  ...
  dstimg->Save("InputImage01AfterAddNoise.bmp");
